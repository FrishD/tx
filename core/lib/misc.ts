...
/**
 * Parses a duration string (eg "1 day") into seconds.
 * @returns duration in seconds, or throws error.
 */
export const parseDurationToSeconds = (inputDuration: string) => {
...
export const calcExpirationFromDuration = (inputDuration: string) => {
    ...
    if (inputDuration === 'permanent') {
        ...
        duration = parseDurationToSeconds(inputDuration);
