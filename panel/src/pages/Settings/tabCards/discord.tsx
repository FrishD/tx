    ...
    return (
        ...
        >
            ...
            <SettingItem label="Wager Blacklist Role ID" htmlFor={cfg.wagerBlacklistRole.eid} showOptional>
                <Input
                    id={cfg.wagerBlacklistRole.eid}
                    ref={wagerBlacklistRoleRef}
                    defaultValue={cfg.wagerBlacklistRole.initialValue}
                    onInput={updatePageState}
                    disabled={pageCtx.isReadOnly}
                    placeholder='000000000000000000'
                />
            ...
            <SettingItem label="Wager Blacklist Log Channel ID" htmlFor={cfg.wagerBlacklistLogChannel.eid} showOptional>
                <Input
                    id={cfg.wagerBlacklistLogChannel.eid}
                    ref={wagerBlacklistLogChannelRef}
                    defaultValue={cfg.wagerBlacklistLogChannel.initialValue}
                    onInput={updatePageState}
                    disabled={pageCtx.isReadOnly}
                    placeholder='000000000000000000'
                />
                <SettingItemDesc>
                    The ID of the channel to send wager blacklist logs to.
                </SettingItemDesc>
            </SettingItem>
            <SettingItem label="Wager Revoke Log Channel ID" htmlFor={cfg.wagerRevokeLogChannel.eid} showOptional>
                <Input
                    id={cfg.wagerRevokeLogChannel.eid}
                    ref={wagerRevokeLogChannelRef}
                    defaultValue={cfg.wagerRevokeLogChannel.initialValue}
                    onInput={updatePageState}
                    disabled={pageCtx.isReadOnly}
                    placeholder='000000000000000000'
                />
